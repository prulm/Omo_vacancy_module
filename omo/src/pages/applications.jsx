...
const Applications = ({ get_applications, isAuthenticated, isLoading, results, user }) => {
            ...
            <div className="apps-container">
                ...
                <div className="apps-body">
                    ...
                    <div className="apps-main-content">
                        ...
                        <JobApplications /> :
                        <ApplicationList no_content="No applications submitted" header="Applications" />
                        : <></>}
                        </>
                         :
...
export default connect(mapStateToProps, { get_applications })(Applications)